                                ...
                                footerData.sections.map((section, index) => {
                                    return (
                                        <div className="text-sm">
                                            <h6 className=" text-primary font-bold font-medium mb-1">
                                                {section.title}
                                            </h6>
                                            <ul>
                                                {
                        ...
                        <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
                            {
                                footerData.socials.map((social, index) => (
                                    <li className="ml-4" key={index}>
                                        <Link href={social.link} className="flex justify-center items-center bg-primary text-primary-content rounded-full transition duration-150 ease-in-out" aria-label={social.company}>
                                            <FontAwesomeIcon icon={social.icon} className='p-2' />
                                        </Link>
                                    </li>
                                ))
                            }
